 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class ParameterElement extends AbstractDocElement {
    ...
    public function getPosition() {
        if (($this->getPreviousElement() instanceof ParameterElement) === false) {
            return 1;
        } else {
     ...
     *
     * @param ParameterElement $other                               The other param
     *                                                              to check
     *                                                              alignment with.
     *
     * @return boolean
     ...
     * @return boolean
     */
    public function alignsWith(ParameterElement $other) {

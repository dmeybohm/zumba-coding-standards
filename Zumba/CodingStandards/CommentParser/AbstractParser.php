 ...
 *  <li>@param as one of its tags, the processParam method will be
...
abstract class AbstractParser {
     ...
     *
     * @return void
     * @throws ParserException If the parser finds a
     *                                                       problem with the
     *                                                       comment.
     */
     ...
     *
     * @return void
     * @throws ParserException If more than the allowed
    ...
    /**
     * Parses \@param array(string) $tokens The word tokens that comprise this element.
     *
    ...
    protected function parseDeprecated($tokens) {
        $this->deprecated = new SingleElement(
            $this->previousElement,
            $tokens,
            'deprecated',
            $this->phpcsFile
    ...
    protected function parseTag($tag, $start, $end) {
        ...
        if ($tag === 'comment' || in_array($tag, $allowedTagNames) === true) {
            ...
            $this->previousElement = new SingleElement(
                $this->previousElement,
                $tokens,
                $tag,
                $this->phpcsFile
        ...
        if ($this->previousElement === null
            || ($this->previousElement instanceof DocElement) === false
        ) {
